...
> Learning [[container]]s by only using high-level tools like [[Docker]] or [[Kubernetes]] can be both frustrating and dangerous. The domain is complex, and approaching it only from one end leaves too many grey areas.
> 
